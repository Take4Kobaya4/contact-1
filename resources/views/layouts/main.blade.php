...
<html lang="ja">
  <head>
    ...
    <link href="{{ asset('contact-template/assets/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('contact-template/assets/css/custom.css') }}" rel="stylesheet">
  </head>
  <body>
    <!-- navbar -->
...
@yield('content')
    ...
    <script src="{{ asset('/contact-template/assets/js/jquery.min.js') }}"></script>
    <script src="{{ asset('/contact-template/assets/js/popper.min.js') }}"></script>
    <script src="{{ asset('contact-template/assets/js/bootstrap.min.js') }}"></script>
  </body>
</html>
